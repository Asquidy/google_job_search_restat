...
*** Data from Rothstein, J. Brookings Papers on Economic Activity (2011)
use rothstein_data
...
****************************************
**Merge in weeks available data and macro data through end of sample.
...
** New macro vars =  labor_force unemp_rate population employment unemployment insured_unemp_rate
...
cap cd "/Users/afradkin/Dropbox/Texas_Job_Search_New/restat_data/Google_Data/"
rename state state_abrv
merge 1:1 state_abrv year month using final_monthly_search_data_2016
drop if _merge==2
drop _merge
