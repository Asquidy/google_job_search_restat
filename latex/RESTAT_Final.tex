...
\footnotetext{Figure \ref{fig:weeks_left_effects} displays the coefficients from a NLLS regression with weeks-left binned at a 5 week level. The results confirm that there is a higher level of search nearer to UI expiration. However, we lose precision on the coefficients past 15 weeks left.}
